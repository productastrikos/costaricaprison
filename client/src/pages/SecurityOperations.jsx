    ...
    return (<div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-3">
        ...
        <div className="flex flex-col gap-4 xl:col-span-2">
          ...
          <Panel title={t('sec.zoneMatrix')} icon={<Icon name="dotsGrid" className="w-4 h-4"/>} className="flex-1" bodyClass="overflow-x-auto overflow-y-auto">
        ...
        <div className="flex flex-col gap-4">
          <Panel title={t('sec.responseTitle')} icon={<Icon name="shield" className="w-4 h-4"/>} subtitle={t('sec.responseSub')} className="flex-1" bodyClass="p-3 space-y-2.5">
            {teams.map((t_) => {
      ...
      <Panel title={t('sec.perimeterPanel')} icon={<Icon name="radio" className="w-4 h-4"/>} bodyClass="p-3">
        ...
        <div className="mt-3 grid grid-cols-2 gap-x-6 gap-y-0.5 lg:grid-cols-4">
