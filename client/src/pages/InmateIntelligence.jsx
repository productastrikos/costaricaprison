    ...
    return (<div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-3">
        ...
        <Panel className="xl:col-span-2" title="Population Roster" icon={<Icon name="dotsGrid" className="w-4 h-4"/>} subtitle={`${fmtNum(filtered.length)} of ${fmtNum(c.inmates.length)} subjects`} actions={<div className="header-search" style={{ padding: '5px 9px' }}>
          ...
          <div className="flex flex-wrap items-center gap-2 px-3 py-2 shrink-0" style={{ borderBottom: '1px solid var(--app-border)' }}>
          ...
          {/* Fills the remaining panel height; absolute inner so the full roster
              scrolls internally without inflating the panel (sticky header). */}
